...
matrix_zf = actual_isi' / (actual_isi * actual_isi' + 1/snr);
matrix_zf = (actual_isi' * actual_isi) \ actual_isi';
% matrix_zf = ((matrix_isi' * matrix_isi) \ (matrix_isi')) * destina_matrix;
...
%% - - - Error - - - %%
[numErrors(counter_e), ber(counter_e)] = biterr(rx_bit(:), randi_bit(:));
[numErrors_zf(counter_e), ber_zf(counter_e)] = biterr(rx_zf_bit(:), randi_bit(:));
